...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const waText = encodeURIComponent(`Hi DealsNut! 🛍️ I want to order "${product.name}" for ₹${product.price}. Is it available? Please confirm!`);
  ...
  wrapper.innerHTML = `
    <div class="pdp-container">
      <div class="pdp-image-wrap">
        <img src="${product.image}" alt="${product.name}" class="pdp-image" />
      ...
      <div class="pdp-info">
        ...
        <div class="pdp-actions">
          ${product.available ? `
            <a href="${waLink}" target="_blank" rel="noreferrer" class="btn-massive btn-massive-wa">
            ...
            <a href="${igLink}" target="_blank" rel="noreferrer" class="btn-massive btn-massive-ig">
  ...
  // Render cross-sell grid, excluding the current product
